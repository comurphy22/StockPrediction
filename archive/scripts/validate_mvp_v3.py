"""
MVP Validation Script V3 - Optimized Keyword Matching
Tests XGBoost with 25-feature set on 10 diverse stocks.
Uses optimized news loading with pre-indexed data for fast keyword matching.
"""
...
print("="*70)
print("MVP VALIDATION V3 - OPTIMIZED NEWS COVERAGE")
print("="*70)
...
for idx, ticker in enumerate(test_stocks, 1):
    ...
    try:
        ...
        # Step 2: Load news sentiment with OPTIMIZED matching
        print(f"   [2/7] Loading news sentiment (OPTIMIZED)...", end=" ")
