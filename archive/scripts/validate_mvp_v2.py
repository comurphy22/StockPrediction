"""
MVP Validation Script V2 - Enhanced with Keyword Matching

This version uses the enhanced data loader that searches for company keywords
in article titles, providing better news coverage for stocks like MSFT, AAPL, AMZN.
"""
...
from data_loader_enhanced import fetch_historical_news_enhanced, aggregate_daily_sentiment_enhanced
...
print("="*70)
print("MVP VALIDATION V2 - ENHANCED NEWS COVERAGE")
print("="*70)
...
for idx, ticker in enumerate(test_stocks, 1):
    ...
    try:
        ...
        # Step 2: Load news sentiment with ENHANCED matching
        print(f"   [2/7] Loading news sentiment (ENHANCED)...", end=" ")
        news_data = fetch_historical_news_enhanced(ticker, f'{YEAR}-01-01', f'{YEAR}-12-31')
        news_sentiment = aggregate_daily_sentiment_enhanced(news_data)
...
results_path = 'Results/mvp_validation_results_v2.csv'
results_df.to_csv(results_path, index=False)
print(f"✅ Saved detailed results: {results_path}")

# Save confusion matrices
cm_path = 'Results/mvp_confusion_matrices_v2.csv'
...
# Save summary
summary_path = 'Results/mvp_validation_summary_v2.csv'
summary_df.to_csv(summary_path, index=False)
print(f"✅ Saved summary statistics: {summary_path}")

print()
print("="*70)
print("MVP VALIDATION V2 COMPLETE")
print("="*70)
